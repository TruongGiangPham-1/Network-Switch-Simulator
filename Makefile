...
#
# Usage: make        // compile dataCenter.cpp
#        make dataCenter // compile dataCenter.cpp
...
ex3s1:  # swich one for ex3.dat
	./dataCenter psw1 ex3.dat null psw2 100-110
ex3s2:
	./dataCenter psw2 ex3.dat psw1 null 200-210

ex2s1:
	./dataCenter psw1 ex2.dat null psw2 100-110
ex2s2:
	./dataCenter psw2 ex2.dat psw1 null 200-210
ex1s1:
	./dataCenter psw1 ex1.dat null null 100-110
